...
🟢 **Strong Buy**: M5 (Base) — Geekbench SC 4,263 (역대 1위), $1,699 (₩2,690,000). AI 성능 4배 향상에 1TB 기본 제공. 대부분의 사용자에게 최적
...
- MacBook Pro 가격대 **$1,699–$7,349** (₩2,690,000–). M5 Pro 14" $2,199 (₩3,490,000), M5 Max 16" $3,899 (₩6,290,000). 전 라인업 1TB/2TB 기본 스토리지로 업그레이드
...
| 모델 | 미국 ($) | 한국 (₩) | 일본 (¥) | 한국 프리미엄 |
|------|---------|----------|---------|------------|
| M5 14" (1TB) | $1,699 | ₩2,690,000 | ¥248,800 (추정) | +9.2% |
| M5 Pro 14" (1TB) | $2,199 | ₩3,490,000 | ¥339,800 (추정) | +9.5% |
| M5 Pro 16" (1TB) | $2,699 | ₩4,290,000 | ¥414,800 (추정) | +9.6% |
| M5 Max 14" (2TB) | $3,599 | ₩5,790,000 | ¥549,800 (추정) | +11.0% |
| M5 Max 16" (2TB) | $3,899 | ₩6,290,000 | ¥599,800 (추정) | +11.3% |
| M5 Max 16" 풀옵션 | $7,349 | 추정 | ¥1,124,800 (추정) | — |

> 환율 기준: $1 ≈ ₩1,450 / ¥150 (2026년 3월).
> 한국/미국 가격: Apple Newsroom 공식 확인. 일본 가격은 추정. 한국 프리미엄 ~9–11%.
...
> M5 Pro가 **달러당 멀티코어 성능 최고** — M5 base의 $100 인상(1TB 전환)으로 역전.
...
> 전 라인업 가격 인상. Base는 스토리지 2배(512GB→1TB), Pro/Max는 Fusion Architecture + AI 프리미엄.
...
**5. 한국 프리미엄 ~9–11% — 전 라인업 동일 수준**

M5 14" 환율 적용가 $1,699 × ₩1,450 = ₩2,463,550 대비 실제 ₩2,690,000은 **+9.2%** 프리미엄이다. M5 Max 16"은 +11.3%까지 올라간다. 과거 5–8%에서 오히려 상승한 수치로, Apple이 원화 약세(₩1,450/$) 속에서 한국 가격을 공격적으로 설정했음을 보여준다. 전 라인업이 ~10% 내외로 균일한 점은 의도적인 가격 정책.
